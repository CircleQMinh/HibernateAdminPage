    ...
    <body>
        ...
        <form action="register" method="post" style="background: #ccc">
            <div class="container">
                ...
                <div class="row">
                    <h3 style="text-align:center;color :#F2E527" >♥</h3>
                </div>
                ...
                <div class="row input-container">
                    ...
                    <div class="col-xs-12">
                        <input type="checkbox" name="agreeTerms"style="color: red">Agree to terms and conditions<br>        
                        <span>${agreeError}</span>
                        <button type="submit "class="btn-lrg submit-btn">Register</button>             
                    </div>
                </div>
        </form>
    </body>
